...
syn cluster markdownInline contains=markdownLineBreak,markdownLinkText,markdownCode,markdownEscape,@htmlTop
...
syn match markdownBlockquote " \{0,4}>\%(\s\|$\)" contained nextgroup=@markdownBlock
